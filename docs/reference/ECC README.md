...
Stars Forks Contributors License Shell TypeScript Python Go Java Markdown
...
Does this work with Cursor / OpenCode?
...
Cursor IDE Support
ecc-universal includes pre-translated configurations for Cursor IDE. The .cursor/ directory contains rules, agents, skills, commands, and MCP configs adapted for Cursor's format.
...
See .cursor/README.md for details and .cursor/MIGRATION.md for the full migration guide.
...
Skills Directory: awesome-agent-skills
📄 License
